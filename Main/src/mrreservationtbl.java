...
public class mrreservationtbl implements designs {
	...
	public void reservations() {
		...
		int[] columnWidths = { 50, 150, 250, 250, 150, 100 }; // Adjust the widths as needed

		for (int i = 0; i < reservemodel.getColumnCount(); i++) {
			TableColumn column = reservationtbl.getColumnModel().getColumn(i);
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (selectedRow != -1) {
					...
					if ("Done".equalsIgnoreCase(status)) {
						JOptionPane.showMessageDialog(null, "Reservation with status 'Done' cannot be edited.",
